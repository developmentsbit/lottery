                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="text" name="game_title" class="form-control  mt-1 @error('game_title') is-invalid @enderror" id="game_title" value="{{old('game_title')}}" autocomplete="off">
                                @error('game_title')
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="text" name="game_title_bn" class="form-control  mt-1  @error('game_title_bn') is-invalid @enderror" id="game_title_bn" value="{{old('game_title_bn')}}" autocomplete="off">
                                @error('game_title_bn')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
