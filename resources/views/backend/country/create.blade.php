    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('country_setup.store')}}" method="post" enctype="multipart/form-data" id="formData">
                            @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="text" name="currency_name" class="form-control  mt-1  @error('currency_name') is-invalid @enderror" id="currency_name" value="{{old('currency_name')}}">
                                @error('currency_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
