    ...
    public function run()
    {
        ...
        \DB::table('menus')->insert(array (
            ...
            array (
                ...
                'label_id' => NULL,
                'parent_id' => 30,
                'menu_name_en' => 'All Lottery',
                'menu_name_bn' => 'All Lottery',
                'system_name' => 'All Lottery',
                'route' => 'all_lottery',
                'slug' => 'index',
                'order_by' => 2,
                'status' => 1,
            ...
            array (
                ...
                'create_by' => 1,
                'deleted_at' => NULL,
                'created_at' => '2024-02-19 15:20:53',
                'updated_at' => '2024-02-19 15:20:53',
            ),
            31 => 
            array (
                'id' => 50,
                'label_id' => 7,
                'parent_id' => NULL,
                'menu_name_en' => 'Buy & Sell',
                'menu_name_bn' => 'কেনা - বেচা',
                'system_name' => 'Buy & Sell',
                'route' => NULL,
                'slug' => 'index',
                'order_by' => 11,
                'status' => 1,
                ...
                'create_by' => 1,
                'deleted_at' => NULL,
                'created_at' => '2024-03-04 12:05:45',
                'updated_at' => '2024-03-04 12:10:40',
            ),
            32 => 
            array (
                'id' => 51,
                'label_id' => NULL,
                'parent_id' => 50,
                'menu_name_en' => 'Member Post',
                'menu_name_bn' => 'সদস্য পোস্ট',
                'system_name' => 'Member Post',
                'route' => 'member_post',
                'slug' => 'index',
                'order_by' => 1,
                'status' => 1,
            ...
            array (
                ...
                'label_id' => NULL,
                'parent_id' => 50,
                'menu_name_en' => 'Public Post',
                'menu_name_bn' => 'পাব্লিক পোস্ট',
                'system_name' => 'Public Post',
                'route' => 'public_post_view',
                'slug' => 'index',
                'order_by' => 2,
                'status' => 0,
                'type' => 2,
                ...
                'create_by' => 1,
                'deleted_at' => NULL,
                'created_at' => '2024-03-04 13:04:06',
                'updated_at' => '2024-03-04 14:14:19',
            ),
            34 => 
            array (
                'id' => 53,
                'label_id' => NULL,
                'parent_id' => 15,
                'menu_name_en' => 'Country Setup',
                'menu_name_bn' => 'দেশ সেটআপ',
                'system_name' => 'Country Setup',
                'route' => 'country_setup',
                'slug' => 'index',
                'order_by' => 9,
                'status' => 1,
            ...
            array (
                ...
                'label_id' => NULL,
                'parent_id' => 15,
                'menu_name_en' => 'Agent Accounts',
                'menu_name_bn' => 'Agent Accounts',
                'system_name' => 'Agent Accounts',
